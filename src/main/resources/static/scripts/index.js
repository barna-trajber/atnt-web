// index.js
var HOST_URL_PATH = location.protocol+'//'+location.hostname+(location.port ? ':'+location.port: '');
var REST_DATA = HOST_URL_PATH + '/api/db';
var KEY_ENTER = 13;
...
function loadItems() {
    xhrGet(REST_DATA, function (data) {
        ...
        console.error(err);
        document.getElementById("loading").innerHTML = "Couldn't connect to the database!";
    });
}
